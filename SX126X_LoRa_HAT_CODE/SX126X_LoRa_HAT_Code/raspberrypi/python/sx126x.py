...
class sx126x:
    ...
    def get_settings(self):
        ...
        GPIO.output(sx126x.M1, GPIO.HIGH)
        time.sleep(0.1)
        ...
        if self.get_reg[0] == 0xC1 and self.get_reg[2] == 0x09:
            ...
            print("Air speed is {0} bps" + sx126x.lora_air_speed_dic.get(None, air_speed_temp))
            print("Power is {0} dBm" + sx126x.lora_power_dic.get(None, power_temp))
            GPIO.output(sx126x.M1, GPIO.LOW)
